...
/** 类型守卫：判断是否为音频内容块 */
export function isAudioContentBlock(block: ContentBlock): block is AudioContentBlock {
  return block.type === 'audio'
}

/** 类型守卫：判断是否为资源内容块 */
export function isResourceContentBlock(block: ContentBlock): block is ResourceContentBlock {
  return block.type === 'resource'
}

/** 类型守卫：判断是否为资源链接内容块 */
export function isResourceLinkContentBlock(block: ContentBlock): block is ResourceLinkContentBlock {
