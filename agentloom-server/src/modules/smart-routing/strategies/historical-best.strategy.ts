...
import { historicalBest } from './historical-best';

export class HistoricalBestRouter extends BaseRouterStrategy {
  readonly name = 'historical_best';
