...
| `/generated-apps/$appId`                         | GeneratedAppDetailPage         | Generated App 创建者详情页：AppSpec、验收场景、Gate 结果、Traceability、Artifacts、Resource bindings 与公开链接管理                                                                                                                |
...
│   ├── generated-app/ # 一句话生成应用 Studio 工作台与公开 runtime：creator API/hooks 管理 readiness/public share；public API/hooks 只消费 `GET /generated-apps/public/:token` 的 end-user runtime surface
