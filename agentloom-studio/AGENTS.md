...
| `/generated-apps/$appId`                         | GeneratedAppDetailPage         | Generated App 创建者详情页：AppSpec、验收场景、Gate 结果、Traceability、Artifacts、Resource bindings、公开链接管理与公开提交记录管理                                                                                               |
...
│   ├── generated-app/ # 一句话生成应用 Studio 工作台与公开 runtime：creator API/hooks 管理 readiness/public share/submissions；public API helpers 可提交/读取 submission，但内置公开页只消费 `GET /generated-apps/public/:token` 的 end-user runtime surface
