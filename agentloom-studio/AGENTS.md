...
| `/generated-apps`                                | GeneratedAppListPage           | 一句话生成应用工作台：创建 Generated App、查看 readiness、管理符合门禁的公开分享链接                                                                                                                                              |
| `/generated-apps/$appId`                         | GeneratedAppDetailPage         | Generated App 创建者详情页：AppSpec、验收场景、Gate 结果、Traceability、Artifacts、Resource bindings、公开链接管理、公开提交记录管理与生成证据/运行记录查看                                                                       |
| `/generated-apps/public/$token`                  | GeneratedAppPublicRuntimePage  | Generated App 公开 runtime 只读入口：无需登录，只展示 title、description、dataUseNotice、有限 AppSpec 与 runtime preview link，不渲染 Studio 壳层                                                                                 |
...
│   ├── generated-app/ # 一句话生成应用 Studio 工作台与公开 runtime：creator API/hooks 管理 readiness/public share/submissions/generation runs/repair attempts/gate runs；public API helpers 可提交/读取 submission，但内置公开页只消费 `GET /generated-apps/public/:token` 的 end-user runtime surface
