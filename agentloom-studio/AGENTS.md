...
│   ├── generated-app/ # 一句话生成应用 Studio 工作台与公开 runtime：creator API/hooks 管理 readiness/public share/submissions/generation runs/repair attempts/gate runs/start runner；public API helpers 与内置公开页可提交/读取 submission，公开页只渲染 end-user runtime/submission 白名单字段、动态业务表单和结构化报告视图
