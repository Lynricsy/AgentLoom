...
interface CanvasActions {
  actions: {
    ...
    applyServerSnapshot: (
      snapshot: CanvasSnapshot & { workflowId: string; version: number },
    ) => void;
...
export const useSelectedNodeIds = () =>
  useCanvasStore((s) => s.selectedNodeIds);

export const useSelectedEdgeId = () => useCanvasStore((s) => s.selectedEdgeId);

export const useMappingPanelEdgeId = () =>
  useCanvasStore((s) => s.mappingPanelEdgeId);
...
export const useIsMiniMapCollapsed = () =>
  useCanvasStore((s) => s.isMiniMapCollapsed);
