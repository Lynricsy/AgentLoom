...
| `/generated-apps/$appId`                         | GeneratedAppDetailPage         | Generated App 创建者详情页：AppSpec、验收场景、Gate 结果、Traceability、Artifacts、受控 workspace 源码/测试/报告预览、Gate 3 构建产物沙箱预览、Resource bindings、自动生成与验证运行、公开链接管理、公开提交记录管理与生成证据/运行记录查看；生成证据区会默认选中最新可见 generation run，让创建者直接看到对应修复尝试与 Gate 证据                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
