...
├── types/
│   ├── port.rs         # PortDataType (8 variants), PortDirection, PortDefinition
...
`ComparisonState` 防循环引用。`PortDataType` 8 种: model/text/json/image/audio/tool/sandbox/knowledge。
...
- `tests/` — 5 checker + 6 validator + 5 WASM browser tests
