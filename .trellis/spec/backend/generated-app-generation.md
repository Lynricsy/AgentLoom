...
- `generated-app.service.spec.ts`
  ...
  - public submission with a same-tenant published Workflow binding calls `ExecutionService.runWorkflow()` and persists only safe async execution handoff fields in public `result/report`
