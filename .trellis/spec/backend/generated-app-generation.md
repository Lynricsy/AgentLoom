...
- `generated-app.service.spec.ts`
  ...
  - Gate 3 real-local runner materializes `dist/index.html` as a business-visible static preview containing escaped AppSpec name, summary, requirements, acceptance scenario output, and data-use notice, and does not regress to an empty `<div id="root"></div>` shell or leak the host workspace root.
